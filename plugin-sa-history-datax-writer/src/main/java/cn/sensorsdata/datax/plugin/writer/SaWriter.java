package cn.sensorsdata.datax.plugin.writer;
...
import cn.sensorsdata.datax.plugin.util.ConverterUtil;
import cn.sensorsdata.datax.plugin.util.NullUtil;
import cn.sensorsdata.datax.plugin.util.SaUtil;
            ...
            while ((record = recordReceiver.getFromReader()) != null) {
                ...
                for (SaColumnItem col : saColumnList) {
                    ...
                    if (column instanceof StringColumn) {
                        ...
                        Object value = ConverterUtil.convert(col.getTargetColumnName(), v, col);
